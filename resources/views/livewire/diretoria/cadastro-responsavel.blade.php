<div class="max-w-3xl mx-auto bg-white rounded-xl shadow p-6">
    ...
    {{-- Botão de salvar --}}
    <button wire:click="salvarResponsavel"
        ...
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div class="bg-white p-6 rounded shadow-xl w-96 relative">
                ...
                <div class="mb-3">
                    ...
                    @error('nomeAluno') <span class="text-red-500 text-sm">{{ $errors->first('nomeAluno') }}</span> @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    @error('dataNascimentoAluno') <span class="text-red-500 text-sm">{{ $errors->first('dataNascimentoAluno') }}</span> @enderror
                </div>
